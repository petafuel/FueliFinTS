...
public class PermissionDataObject
{
	...
	public static List<GlobalParameter> getBankParameters()
	{
		if (bankParameters == null)
		{
			...
			bankParameters.add(new GlobalParameter("HICCMS", 1, 10, "1", "2", "1000:J:J", ""));    //	Sammel Einreichung
			...
			//17	SEPA-Parameter
			bankParameters.add(new GlobalParameter("HISPAS", 1, 1, "1", "1", "J:N:N:sepade.pain.001.001.02.xsd:sepade.pain.001.002.02.xsd:sepade.pain.001.002.03.xsd:sepade.pain.008.002.02.xsd:sepade.pain.008.003.02.xsd", ""));
			bankParameters.add(new GlobalParameter("HISPAS", 2, 1, "1", "1", "J:N:N:N:sepade.pain.001.001.02.xsd:sepade.pain.001.002.02.xsd:sepade.pain.001.002.03.xsd:sepade.pain.008.002.02.xsd:sepade.pain.008.003.02.xsd", ""));
			//19	Überweisung IZV
			bankParameters.add(new GlobalParameter("HIUEBS", 5, 1, "1", "2", "14:51:53:54:67:69", ""));
			//20
			bankParameters.add(new GlobalParameter("HITANS", 1, 1, "1", "1", "J:N:1:0:" + iTAN.getElementVersion1String() + ":" + mTAN.getElementVersion1String() + ":" + iTANsms.getElementVersion1String(), ""));
			bankParameters.add(new GlobalParameter("HITANS", 2, 1, "1", "1", "J:N:1:" + iTAN.getElementVersion2String() + ":" + mTAN.getElementVersion2String() + ":" + iTANsms.getElementVersion2String(), ""));
			bankParameters.add(new GlobalParameter("HITANS", 3, 1, "1", "1", "J:N:1:" + iTAN.getElementVersion3String() + ":" + mTAN.getElementVersion3String() + ":" + iTANsms.getElementVersion3String(), ""));
			bankParameters.add(new GlobalParameter("HITANS", 4, 1, "1", "1", "J:N:1:" + iTAN.getElementVersion4String() + ":" + mTAN.getElementVersion4String() + ":" + iTANsms.getElementVersion4String(), ""));
			bankParameters.add(new GlobalParameter("HITANS", 5, 1, "1", "1", "J:N:1:" + iTAN.getElementVersion5String() + ":" + mTAN.getElementVersion5String() + ":" + iTANsms.getElementVersion5String(), ""));
			//25
            ...
            //29
            bankParameters.add(new GlobalParameter("HICSES", 1, 1, "1", "2", "7:14", ""));
            bankParameters.add(new GlobalParameter("HICMES", 1, 10, "1", "2", "7:14:0:N:J", ""));
			...
			bankParameters.add(new GlobalParameter("HIBMES", 1, 1, "1", "2", "1:14:1:14:1000:N:J", ""));	//Einreichung Firmensammellastschrift
			bankParameters.add(new GlobalParameter("HIBMLS", 1, 1, "1", "2", "", ""));		//Firmensammellastschrift löschen
			bankParameters.add(new GlobalParameter("HIBSES", 1, 1, "1", "2", "1:14:1:14", "")); 	//Einreichung Firmeneinzellastschrift
			bankParameters.add(new GlobalParameter("HIBSLS", 1, 1, "1", "2", "J", ""));		//Firmeneinzellastschrift löschen
		}
	...
	public static HashMap<FINTS30, Boolean> getPinRequired()
	{
		if (pinRequired == null)
		{
			...
			pinRequired.put(FINTS30.PinTanVerfahren, true);
	...
	public enum FINTS30
	{
		SaldoAbfrage, UmsatzAbfrage, PinTanVerfahren,
		...
		PinAendern,
		KundenBankNachricht,
		Vormerkumsaetze, SepaLastschriftEinzelLoeschenB2B, SepaLastschriftEinzelEinreichenB2B, SepaLastschriftEinzelBestandB2B, SepaLastschriftSammelEinreichenB2B, SepaLastschriftSammelBestandB2B, SepaLastschriftSammelLoeschenB2B,
	}
