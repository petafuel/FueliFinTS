...
public class HITAN extends Segment {
    ...
    @Element(
            description = {@ElementDescription(number = 6, status = ElementDescription.StatusCode.C, segmentVersion = 4),
                    @ElementDescription(number = 6, status = ElementDescription.StatusCode.C, segmentVersion = 5)})
    @bin
    private byte[] challengeHHD_UC;

    @Element(
            description = {@ElementDescription(number = 6, status = ElementDescription.StatusCode.O, segmentVersion = 1),
    ...
    @Element(
            description = {@ElementDescription(number = 7, status = ElementDescription.StatusCode.C, length = -20, segmentVersion = 1),
    ...
    @Element(
            description = {@ElementDescription(number = 9, status = ElementDescription.StatusCode.C, length = -32, segmentVersion = 3),
