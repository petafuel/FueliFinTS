...
public class HKCCM extends Segment implements IExecutableElement, IDependentElement {
    ...
    @Element(
            description = {@ElementDescription(number = 5, length = -256)})
    @an
