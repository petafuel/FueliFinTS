...
public class NIOSocketListenerThreadTest {
    ...
    public void testRun() throws Exception {
        ...
        NIOSocketListenerThread thread = new NIOSocketListenerThread(3001, server);
        ...
        Socket s = socketFactory.createSocket("localhost", 3001);
        s.setSoTimeout(1000);
